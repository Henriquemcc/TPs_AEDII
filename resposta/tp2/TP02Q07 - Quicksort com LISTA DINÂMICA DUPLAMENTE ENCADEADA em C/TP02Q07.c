...
/**
 * Funcao da funcao: Esta funcao serve para criar uma nova struct do tipo Presidente vazia.
 * @return Struct do tipo Presidente vazia.
*/
Presidente novoPresidente()
{
    ...
    return presidente;
}//fim da funcao novoPresidente

/**
 * Funcao da funcao: Esta funcao serve para criar uma nova celula dupla passando como parametro um objeto do tipo Presidente.
 * @param elemento Struct do tipo Presidente que sera adicionada a nova celula dupla.
 * @return Ponteiro para a struct do tipo CelulaDupla que foi criada.
*/
CelulaDupla* novaCelulaDupla(Presidente elemento)
{
    ...
    return nova;
}//fim da funcao novaCelulaDupla

/**
 * Funcao da funcao: Esta funcao serve para criar uma nova celula dupla vazia.
 * @return Ponteiro para a struct do tipo CelulaDupla vazia que foi criada.
*/
CelulaDupla* novaCelulaDuplaVazia()
{
    CelulaDupla* nova=(CelulaDupla*)malloc(sizeof(CelulaDupla));
    nova->elemento=novoPresidente();
    nova->ant=nova->prox=NULL;
    return nova;
}//fim da funcao novaCelulaDuplaVazia
...
/**
 * Funcao da funcao: Esta funcao serve para criar uma lista dupla sem elementos (somente com o no cabeca).
*/
void start()
{
...
/**
 * Funcao da funcao: Esta funcao serve para inserir uma struct do tipo Presidente na posicao inicial da lista dinamica dupla.
 * @param x Struct do tipo Presidente que sera inserida na posicao inicial da lista dinamica.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para inserir uma struct do tipo Presidente na posicao final da lista dinamica dupla.
 * @param x Struct do tipo Presidente que sera inserida na posicao final da lista dinamica.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para remover uma struct do tipo Presidente da posicao inicial da lista dinamica dupla.
 * @return Struct do tipo Presidente removida da lista dinamica.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para remover uma struct do tipo Presidente do posicao final da lista dinamica dupla.
 * @return Struct do tipo Presidente removida da lista dinamica.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para obter o tamanho da lista dinamica dupla.
 * @return Numero inteiro indicando a quantidade de elementos na lista dinamica.
*/
int tamanho()
{
    int tamanho=0;
...
/**
 * Funcao da funcao: Esta funcao serve para inserir uma struct do tipo Presidente de uma posicao especifica da lista dinamica dupla.
 * @param x Struct do tipo Presidente que sera inserida na lista dinamica.
 * @param pos Posicao da lista dinamica a qual sera inserida a struct do tipo Presidente.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para remover uma struct do tipo Presidente de uma posicao especifica da lista dinamica dupla.
 * @param pos Posicao da lista dinamica a qual sera removida a struct do tipo Presidente.
 * @return Struct do tipo Presidente removida da lista dinamica.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para obter a celula dupla de uma posicao espeficica da lista dinamica dupla.
 * @param posicao Posicao a qual sera retornada a celula dupla.
 * @return Ponteiro para a struct do tipo CelulaDupla da posicao especificada.   
*/
CelulaDupla* getCelulaDuplaPosicaoEspecifica(int posicao)
{
    CelulaDupla* i=primeiro->prox;
    ...
    return i;
}//fim da funcao getCelulaDuplaPosicaoEspecifica

/**
 * Funcao da funcao: Esta funcao serve para trocar as structs do tipo Presidente de duas celulas da lista dinamica dupla.
 * @param i Struct do tipo CelulaDupla cujo elemento struct do tipo Presidente sera trucada com o elemento struct do tipo Presidente da Struct do tipo CelulaDupla j.
 * @param j Struct do tipo CelulaDupla cujo elemento struct do tipo Presidente sera trucada com o elemento struct do tipo Presidente da Struct do tipo CelulaDupla i.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para ordenar a lista dinamica dupla por meio do algoritmo de ordenacao quickSort.
 * @param esquerda Posicao limite inferior da area a ser ordenada.
 * @param direita Posicao limite superior da area a ser ordenada.
*/
void quickSort(int esquerda, int direita)
{
    ...
    int pivo=getCelulaDuplaPosicaoEspecifica((direita+esquerda)/2)->elemento.id;
    while(i<=j)
    {
        while(getCelulaDuplaPosicaoEspecifica(i)->elemento.id<pivo)
        {
            i++;
        }
        while(getCelulaDuplaPosicaoEspecifica(j)->elemento.id>pivo)
        {
            j--;
        }
        if(i<=j)
...
/**
 * Funcao da funcao: Esta funcao serve para chamar a funcao quickSort sem passar parametros.
*/
...
/**
 * Funcao da funcao: Esta funcao serve para ordenar a lista dinamica dupla por meio do algoritmo de ordenacao quickSort, contando o tempo gasto e salvando esse dado em um arquivo.
*/
void ordenar()
{
    srand(time(NULL));
    ...
    FILE *arquivo =fopen("618557_quicksort2.txt", "a");
...
/**
 * Funcao da funcao: Esta funcao serve para mostrar todos os dados das structs do tipo Presidente da lista dinamica dupla.
*/
void mostrar()
{
